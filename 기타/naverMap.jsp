...
<html>
<head>
<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=tua2e9wo8k"></script>
...
function initMap() {
    ...
    var marker = new naver.maps.Marker({
        map: map,
        title: "우정초밥",
        position: new naver.maps.LatLng(37.5929960, 127.0342868),
        icon: {
    ...
    naver.maps.Event.once(map, 'init', function() {
        ...
        naver.maps.Event.addDOMListener(customControl.getElement(), 'click', function() {
            map.setCenter(new naver.maps.LatLng(37.5929960, 127.0342868));
        });
    ...
    /* var cityhall = new naver.maps.LatLng(37.5929960, 127.0342868),
     ...
     var contentString = [
            '<div class="iw_inner">',
            /* '<img src="/img/uj1.png" width="100" height="55" alt="" class="thumb" /><br />', */
            ...
            '       <a href="http://localhost/uj/home" target="_blank">http://localhost/uj/home</a>',
            '   </p>',
            '</div>'
        ].join('');
	...
	<div>
	<p>
		<button type = button class="button button1" onclick = "location.href='https://map.naver.com/v5/directions/-/14141397.151503626,4522094.137155175,%EC%9A%B0%EC%A0%95%EC%B4%88%EB%B0%A5,1156260886,PLACE_POI/-/car?c=14141397.1515036,4522094.1371552,15,0,0,0,dh'">길 찾 기</button>
		<ul>
          <li>
            <strong>우정초밥</strong>
          </li>
          <li>
            서울특별시 성북구 종암동 종암로3길 31
          </li>
          <li>
            전화번호 : <a href='tel:050713472333'>050713472333</a>
          </li>
          <li>
            이용시간 :  <strong>런치</strong><em> 25.000원</em> 1부)11시30분 2부)1시5분   <strong>디너</strong><em> 35.000원</em> 1부)5시30분 2부) 7시5분 <br>
						<u>매주 토요일 낮12시 부터 1주일 예약 시작</u><br>
						<span style="color:red;">휴무일</span> : 월요일 , 목요일 (변경 될 수 있습니다)<br>
						디엠 전화 예약불가합니다<br>
          </li>
          <li>
            주차공간 : 공간이 협소하여 대중교통 이용 바랍니다.
          </li>
        </ul>
	</div>
</body>
